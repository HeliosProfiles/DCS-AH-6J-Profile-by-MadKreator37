...
### Minimum Helios version required: 1.6.618
...
This is a Helios profile for the amazing AH-6J Community Mod, created by Tobsen and Eightball, designed for DCS World and contributed by @MadKreator37 and @Bluefinbima. 
...
### IMPORTANT! PLEASE READ!
 NEW USERS:The patches for the exported viewports and the adjusted files for various displays to function properly are  included in the download and will be automatically applied via "DCS Additional Viewports". You will need to "Revert" then "Install" patches while setting up the profile.
